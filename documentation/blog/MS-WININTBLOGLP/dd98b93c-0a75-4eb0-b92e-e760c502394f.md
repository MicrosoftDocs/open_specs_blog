...
<p>If you used Microsoft Message Analyzer to convert ETL-format packet capture files to PCAP format, you can get the same functionality from the <span><a href="https://github.com/microsoft/etl2pcapng">open source etl2pcapng tool</a></span>.</p>
